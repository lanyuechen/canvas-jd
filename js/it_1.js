...
(function(){
    ...
    p.initLoader = function()
    {
        var cur = this;
        var resourcesAry = [
            {id:"title", type:"texture", url:"images/it_1/title.png"},
    ...
    p.initData = function()
    {
        ...
        var apiUrl = "http://data.jd.com/digitalBUData?type=api6_98b22c38_961c_4476_b01b_dd880b8216f1";
    ...
    p.createBox = function()
    {
        ...
        this.boxContainer.position.x = -350;
        this.boxContainer.position.y = -200;
    ...
    p.createInnerParticle = function()
    {
        ...
        for(var i =0; i<this.topNum; i++)
        {
            ...
            innerParticle.position.x = i*this.space;
   ...
   /* p.innerParticleAppear = function()
    ...
    p.createTitleSum = function()
    {
        ...
        this.titleSum.position.set(360,355,0);
    };
